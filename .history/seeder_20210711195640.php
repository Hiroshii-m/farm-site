...
try{
    ...
    for($i = 1601; $i <= 1900; $i++){
        ...
        $data = array(':s_name' => '沖本', ':email' => $email, ':pass' => password_hash('password', PASSWORD_DEFAULT), ':a_path' => 'uploads/9317952a6529c74a68fc75ae839057504f2fba6c.png', ':create_date' => date('Y-m-d H:i:s'));
        // クエリ実行
