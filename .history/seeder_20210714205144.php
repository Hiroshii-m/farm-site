...
try{
    ...
    for($i = 675; $i <= 736; $i++){
        ...
        ・果実
        柿
        ・米', ':postcode' => '7231234', ':p_id' => '47', ':c_id' => $c_id, ':street' => '東2条5番地', ':img1' => 'uploads/aecdf9a4649fc3397eb22797c4b03383edc5e210.jpeg', ':img2' => 'uploads/41aad9be5552cf469f62b8c61df1ed380d23f8fa.jpeg', ':img3' => '', ':create_date' => date('Y-m-d H:i:s'));
        // クエリ実行
        queryPost($dbh, $sql, $data);
        header("Location:mypage.php");
    }
