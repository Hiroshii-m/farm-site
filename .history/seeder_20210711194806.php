...
try{
    ...
    for($i = 1601; $i <= 1900; $i++){
        ...
        $data = array(':s_name' => '沖本', ':email' => $email, ':pass' => password_hash('password', PASSWORD_DEFAULT), ':a_path' => 'uploads/58c414feea7889e11e19ca37d5f47e7f24ba1efc.jpeg', ':create_date' => date('Y-m-d H:i:s'));
        // クエリ実行
