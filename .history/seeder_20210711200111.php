...
try{
    ...
    for($i = 2401; $i <= 2700; $i++){
        ...
        $data = array(':s_name' => '生協グループ', ':email' => $email, ':pass' => password_hash('password', PASSWORD_DEFAULT), ':a_path' => 'uploads/8cb250283c5a4cfebe93aa914eec33ffb4935e17.png', ':create_date' => date('Y-m-d H:i:s'));
        // クエリ実行
