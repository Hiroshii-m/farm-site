...
try{
    ...
    for($i = 0; $i <= 61; $i++){
        ...
        皮が薄く、酸味が少ないピンク系と、皮も赤く、うま味が強い赤系のトマトがあります。トマトを生で食べることが多い日本では「桃太郎」に代表されるピンク系が主流。調理用トマトなどが赤系で、味が濃く、加熱するとうま味が増すのが特徴です。ケチャップやトマト缶などの加工品にも用いられています。', ':category_id' => 2, ':term' => '春、夏。', ':p_value' => '100', ':p_number' => '1個', ':p_img' => 'uploads/b1aea79fd7b31fb9d156e203e6ca1640ac6d0891.png', ':create_date' => date('Y-m-d H:i:s'));
        // クエリ実行
        queryPost($dbh, $sql, $data);
        header("Location:mypage.php");
    }
