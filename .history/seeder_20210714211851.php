...
try{
    ...
    for($i = 675; $i <= 736; $i++){
        ...
        $u_id = 2219 + $k;
        $c_id = $i;
        $data = array(':s_id' => $s_id, ':u_id' => $u_id, ':p_name' => '', ':p_detail' => '', ':category_id' => '13', ':c_id' => $c_id, ':street' => '東2条5番地', ':img1' => 'uploads/3002ac290f0d88b0cf1605d1b85624db7d663bbd.png', ':img2' => 'uploads/aecdf9a4649fc3397eb22797c4b03383edc5e210.jpeg', ':img3' => 'uploads/41aad9be5552cf469f62b8c61df1ed380d23f8fa.jpeg', ':create_date' => date('Y-m-d H:i:s'));
        // クエリ実行
        queryPost($dbh, $sql, $data);
        header("Location:mypage.php");
    }
