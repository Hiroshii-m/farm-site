...
try{
    ...
    for($i = 675; $i <= 736; $i++){
        ...
        ・果実
        柿
        ・米', ':postcode' => '7231234', ':p_id' => '47', ':c_id' => $c_id, ':street' => '東2条5番地', ':img1' => 'uploads/948f35bb80447fbe5d8b35b11f2daf9bdf6c2dd6.png', ':img2' => 'uploads/41aad9be5552cf469f62b8c61df1ed380d23f8fa.jpeg', ':img3' => '', ':create_date' => date('Y-m-d H:i:s'));
        // クエリ実行
        queryPost($dbh, $sql, $data);
        header("Location:mypage.php");
    }
