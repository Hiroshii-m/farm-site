...
try{
    ...
    for($i = 675; $i <= 736; $i++){
        ...
        $u_id = 2095 + $k;
        $c_id = $i;
        $data = array(':u_id' => $u_id, ':s_name' => '玉ねぎ大好き！テキサス農園', ':s_profile' => '新鮮な野菜を置いてます！
        ...
        ・果実
        柿
        ・米', ':postcode' => '7231234', ':p_id' => '13', ':c_id' => $c_id, ':street' => '東2条5番地', ':img1' => 'uploads/41aad9be5552cf469f62b8c61df1ed380d23f8fa.jpeg', ':img2' => 'uploads/aecdf9a4649fc3397eb22797c4b03383edc5e210.jpeg', ':img3' => 'uploads/8bb0826ff7f7e2a6223010afb1f4861ca24624ca.jpeg', ':create_date' => date('Y-m-d H:i:s'));
        // クエリ実行
        queryPost($dbh, $sql, $data);
        header("Location:mypage.php");
    }
