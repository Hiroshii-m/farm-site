...
try{
    ...
    for($i = 1601; $i <= 1900; $i++){
        ...
        $data = array(':s_name' => '沖本', ':email' => $email, ':pass' => password_hash('password', PASSWORD_DEFAULT), ':a_path' => 'uploads/061f94a238bead61533ebf4cd6c2bdf9c8e12974.png', ':create_date' => date('Y-m-d H:i:s'));
        // クエリ実行
