...
try{
    ...
    for($i = 301; $i <= 400; $i++){
        $data = array(':s_name' => '', ':email' => $email, ':pass' => password_hash('password', PASSWORD_DEFAULT), ':a_path' => 'uploads/ad25e01010453a7fc8d4ae95fe10f731b581af71.jpeg', ':create_date' => date('Y-m-d H:i:s'));
        // クエリ実行
        queryPost($dbh, $sql, $data);
        header("Location:mypage.php");
    }
