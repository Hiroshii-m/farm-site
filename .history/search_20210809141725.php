                    ...
                    <h2 class="p-shopList__heading">
                        ...
                        <div class="p-shopList__terms">
                            ...
                            <?php if(!empty($_GET['category_id']) && is_numeric($_GET['category_id'])){ ?>
                                <span class="p-shopList__tag u-tag-accent"><?= $categoryName ?></span>
                            <?php } ?>
                        </div>
                    </h2>
                        ...
                        <li class="c-card">
                            <div class="c-card__head u-flex-between">
                                ...
                                <div class="c-card__summary">
                                    ...
                                    <div class="p-shopList__wrap">
                                        <a class="u-margin-left-20" href="single.php<?= appendGetParam().'&shop_id='.sanitize($val['id']); ?>" class="c-card__title"><?= sanitize(showData($val['shop_name'])); ?></a>
