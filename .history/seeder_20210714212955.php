...
try{
    ...
    for($i = 0; $i <= 61; $i++){
        ...
        皮が薄く、酸味が少ないピンク系と、皮も赤く、うま味が強い赤系のトマトがあります。トマトを生で食べることが多い日本では「桃太郎」に代表されるピンク系が主流。調理用トマトなどが赤系で、味が濃く、加熱するとうま味が増すのが特徴です。ケチャップやトマト缶などの加工品にも用いられています。', ':category_id' => 2, ':term' => '秋、夏。', ':p_value' => '100', ':p_number' => '500g', ':p_img' => 'uploads/b1ec76f6cdc0ed3202e1d2683a742f2c164a1a5a.png', ':create_date' => date('Y-m-d H:i:s'));
        // クエリ実行
        queryPost($dbh, $sql, $data);
        header("Location:mypage.php");
    }
