...
try{
    ...
    for($i = 263; $i <= 303; $i++){
        ...
        ・果実
        柿
        ・米', ':postcode' => '7231234', ':p_id' => '4', ':c_id' => $c_id, ':street' => '東2条5番地', ':img1' => '', ':img2' => 'uploads/41aad9be5552cf469f62b8c61df1ed380d23f8fa.jpeg', ':img3' => 'uploads/8bb0826ff7f7e2a6223010afb1f4861ca24624ca.jpeg', ':create_date' => date('Y-m-d H:i:s'));
        // クエリ実行
        queryPost($dbh, $sql, $data);
        header("Location:mypage.php");
    }
