...
try{
    ...
    for($i = 0; $i <= 61; $i++){
        ...
        $u_id = 2220 + $i;
        $c_id = $i;
        $data = array(':s_id' => $s_id, ':u_id' => $u_id, ':p_name' => '西洋カボチャ', ':p_detail' => '日本カボチャ、西洋カボチャ、ぺポカボチャの３種類に分けられ、現在の主流は、ほくほくして甘みの強い西洋カボチャです。', ':category_id' => 2, ':term' => '秋、夏。', ':p_value' => '', ':p_number' => '', ':p_img' => 'uploads/b1ec76f6cdc0ed3202e1d2683a742f2c164a1a5a.png', ':create_date' => date('Y-m-d H:i:s'));
        // クエリ実行
        queryPost($dbh, $sql, $data);
        header("Location:mypage.php");
    }
