...
try{
    $dbh = dbConnect();
    $sql = 'INSERT INTO shops (`shop_name`, `social_profile`, `postcode`, `prefecture_id`, `city_id`, `street`, `shop_img1`, `shop_img2`, `shop_img3`, `create_date`) VALUES(:s_name, :s_profile, :postcode, :p_id, :c_id, :create_date)';
