...
try{
    ...
    for($i = 869; $i <= 1000; $i++){
        ...
        $data = array(':s_name' => '芥見', ':email' => $email, ':pass' => password_hash('password', PASSWORD_DEFAULT), ':a_path' => 'uploads/1f356686fc6ad4799eb68a6979591a3fbd3181aa.png', ':create_date' => date('Y-m-d H:i:s'));
        // クエリ実行
