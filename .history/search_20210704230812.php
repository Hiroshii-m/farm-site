                        ...
                        <li class="c-card">
                            <div class="c-card__head u-flex-between">
                                ...
                                <div class="c-submission__icon">
                                    <i class="fa-heart c-submission__fav js-click-animation <?= (isFavorite($val['id'], $u_id)) ? 'fas is-active' : 'far'; ?>" data-shopid="<?= sanitize($val['id']); ?>"></i>
                                    <i class="fa-heart c-submission__fav2 js-click-animation2 <?= (isFavorite($val['id'], $u_id)) ? 'far is-active' : 'fas'; ?>"></i>
                                </div>
                            </div>
