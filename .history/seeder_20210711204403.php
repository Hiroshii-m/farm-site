...
try{
    ...
    for($i = 793; $i <= 835; $i++){
        ...
        ・果実
        柿
        ・米', ':postcode' => '7231234', ':p_id' => '16', ':c_id' => $c_id, ':street' => '東2条5番地', ':img1' => 'uploads/810a412b314a4a629c5690ef9ce973b7279cc8d3.png', ':img2' => 'uploads/41aad9be5552cf469f62b8c61df1ed380d23f8fa.jpeg', ':img3' => '', ':create_date' => date('Y-m-d H:i:s'));
        // クエリ実行
        queryPost($dbh, $sql, $data);
        header("Location:mypage.php");
    }
